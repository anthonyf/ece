  ...
  (cl:let ((pc initial-pc)
    ...
    (cl:tagbody
     ...
     pc-4188
       ...
       (cl:setf pc 4189)
     pc-4189
       (cl:setf val '|%procedure-name-ref|)
       (cl:setf pc 4190)
     pc-4190
       (cl:setf argl (cl:funcall (get-operation '|cons|) val argl))
       (cl:setf pc 4191)
     pc-4191
       ...
       (cl:setf pc 4192)
     pc-4192
       (cl:when flag (cl:setf pc 4207) (cl:go pc-4207))
     pc-4193
       (cl:setf flag (cl:funcall (get-operation '|continuation?|) proc))
       (cl:setf pc 4194)
     pc-4194
     ...
     pc-4197
       (cl:setf continue (cl:cons '|boot-env| 4208))
       (cl:setf pc 4198)
     pc-4198
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 4199)
     ...
     pc-4421
       ...
       (cl:setf pc 4422)
     pc-4422
       (cl:when flag (cl:setf pc 4437) (cl:go pc-4437))
     pc-4423
       (cl:setf flag (cl:funcall (get-operation '|continuation?|) proc))
       (cl:setf pc 4424)
     pc-4424
       (cl:when flag (cl:setf pc 4430) (cl:go pc-4430))
     pc-4425
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 4426)
     pc-4426
     ...
     pc-4427
       (cl:setf continue (cl:cons '|boot-env| 4438))
       (cl:setf pc 4428)
     pc-4428
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 4429)
     ...
     pc-4441
       ...
       (cl:setf pc 4442)
     pc-4442
       (cl:setf val '|%code-object-push-instruction!|)
       (cl:setf pc 4443)
     pc-4443
       (cl:setf argl (cl:funcall (get-operation '|cons|) val argl))
       (cl:setf pc 4444)
     pc-4444
       ...
       (cl:setf pc 4445)
     pc-4445
       (cl:when flag (cl:setf pc 4460) (cl:go pc-4460))
     pc-4446
       (cl:setf flag (cl:funcall (get-operation '|continuation?|) proc))
       (cl:setf pc 4447)
     pc-4447
       (cl:when flag (cl:setf pc 4453) (cl:go pc-4453))
     pc-4448
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 4449)
     pc-4449
     ...
     pc-4450
       (cl:setf continue (cl:cons '|boot-env| 4461))
       (cl:setf pc 4451)
     pc-4451
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 4452)
     ...
     pc-4464
       ...
       (cl:setf pc 4465)
     pc-4465
       (cl:setf val '|%code-object-set-label!|)
       (cl:setf pc 4466)
     pc-4466
       (cl:setf argl (cl:funcall (get-operation '|cons|) val argl))
       (cl:setf pc 4467)
     pc-4467
       ...
       (cl:setf pc 4468)
     pc-4468
       (cl:when flag (cl:setf pc 4483) (cl:go pc-4483))
     pc-4469
       (cl:setf flag (cl:funcall (get-operation '|continuation?|) proc))
       (cl:setf pc 4470)
     pc-4470
       (cl:when flag (cl:setf pc 4476) (cl:go pc-4476))
     pc-4471
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 4472)
     pc-4472
     ...
     pc-4473
       (cl:setf continue (cl:cons '|boot-env| 4484))
       (cl:setf pc 4474)
     pc-4474
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 4475)
     ...
     pc-4487
       ...
       (cl:setf pc 4488)
     pc-4488
       (cl:setf val '|%code-object-set-name!|)
       (cl:setf pc 4489)
     pc-4489
       (cl:setf argl (cl:funcall (get-operation '|cons|) val argl))
       (cl:setf pc 4490)
     pc-4490
       ...
       (cl:setf pc 4491)
     pc-4491
       (cl:when flag (cl:setf pc 4506) (cl:go pc-4506))
     pc-4492
       (cl:setf flag (cl:funcall (get-operation '|continuation?|) proc))
       (cl:setf pc 4493)
     pc-4493
     ...
     pc-4496
       (cl:setf continue (cl:cons '|boot-env| 4507))
       (cl:setf pc 4497)
     pc-4497
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 4498)
     ...
     pc-4510
       ...
       (cl:setf pc 4511)
     pc-4511
       (cl:setf val '|%code-object-set-arity!|)
       (cl:setf pc 4512)
     pc-4512
       (cl:setf argl (cl:funcall (get-operation '|cons|) val argl))
       (cl:setf pc 4513)
     ...
     pc-4519
       (cl:setf continue (cl:cons '|boot-env| 4530))
       (cl:setf pc 4520)
     pc-4520
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 4521)
     ...
     pc-4533
       ...
       (cl:setf pc 4534)
     pc-4534
       (cl:setf val '|%code-object-set-source-loc!|)
       (cl:setf pc 4535)
     pc-4535
       (cl:setf argl (cl:funcall (get-operation '|cons|) val argl))
       (cl:setf pc 4536)
     ...
     pc-4538
       ...
       (cl:setf pc 4539)
     pc-4539
       (cl:when flag (cl:setf pc 4545) (cl:go pc-4545))
     pc-4540
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 4541)
     pc-4541
     ...
     pc-4542
       (cl:setf continue (cl:cons '|boot-env| 4553))
       (cl:setf pc 4543)
     pc-4543
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 4544)
     ...
     pc-4556
       ...
       (cl:setf pc 4557)
     pc-4557
       (cl:setf val '|execute-code-object|)
       (cl:setf pc 4558)
     pc-4558
       (cl:setf argl (cl:funcall (get-operation '|cons|) val argl))
       (cl:setf pc 4559)
     pc-4559
       ...
       (cl:setf pc 4560)
     pc-4560
       (cl:when flag (cl:setf pc 4575) (cl:go pc-4575))
     pc-4561
       (cl:setf flag (cl:funcall (get-operation '|continuation?|) proc))
       (cl:setf pc 4562)
     pc-4562
       (cl:when flag (cl:setf pc 4568) (cl:go pc-4568))
     pc-4563
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 4564)
     pc-4564
     ...
     pc-4565
       (cl:setf continue (cl:cons '|boot-env| 4576))
       (cl:setf pc 4566)
     pc-4566
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 4567)
     ...
     pc-4582
       ...
       (cl:setf pc 4583)
     pc-4583
       (cl:when flag (cl:setf pc 4598) (cl:go pc-4598))
     pc-4584
       (cl:setf flag (cl:funcall (get-operation '|continuation?|) proc))
       (cl:setf pc 4585)
     pc-4585
       (cl:when flag (cl:setf pc 4591) (cl:go pc-4591))
     pc-4586
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 4587)
     pc-4587
     ...
     pc-4588
       (cl:setf continue (cl:cons '|boot-env| 4599))
       (cl:setf pc 4589)
     pc-4589
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 4590)
     ...
     pc-5270
       ...
       (cl:setf pc 5271)
     pc-5271
       (cl:when flag (cl:setf pc 5286) (cl:go pc-5286))
     pc-5272
       (cl:setf flag (cl:funcall (get-operation '|continuation?|) proc))
       (cl:setf pc 5273)
     pc-5273
       (cl:when flag (cl:setf pc 5279) (cl:go pc-5279))
     pc-5274
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 5275)
     pc-5275
     ...
     pc-5276
       (cl:setf continue (cl:cons '|boot-env| 5287))
       (cl:setf pc 5277)
     pc-5277
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 5278)
     ...
     pc-5500
       ...
       (cl:setf pc 5501)
     pc-5501
       (cl:when flag (cl:setf pc 5516) (cl:go pc-5516))
     pc-5502
       (cl:setf flag (cl:funcall (get-operation '|continuation?|) proc))
       (cl:setf pc 5503)
     pc-5503
       (cl:when flag (cl:setf pc 5509) (cl:go pc-5509))
     pc-5504
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 5505)
     pc-5505
     ...
     pc-5506
       (cl:setf continue (cl:cons '|boot-env| 5517))
       (cl:setf pc 5507)
     pc-5507
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 5508)
     ...
     pc-5523
       ...
       (cl:setf pc 5524)
     pc-5524
       (cl:when flag (cl:setf pc 5539) (cl:go pc-5539))
     pc-5525
       (cl:setf flag (cl:funcall (get-operation '|continuation?|) proc))
       (cl:setf pc 5526)
     pc-5526
       (cl:when flag (cl:setf pc 5532) (cl:go pc-5532))
     pc-5527
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 5528)
     pc-5528
     ...
     pc-5529
       (cl:setf continue (cl:cons '|boot-env| 5540))
       (cl:setf pc 5530)
     pc-5530
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 5531)
     ...
     pc-5548
       ...
       (cl:setf pc 5549)
     pc-5549
       (cl:when flag (cl:setf pc 5555) (cl:go pc-5555))
     pc-5550
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 5551)
     pc-5551
       (cl:when flag (cl:setf pc 5560) (cl:go pc-5560))
     pc-5552
       (cl:setf continue (cl:cons '|boot-env| 5563))
       (cl:setf pc 5553)
     pc-5553
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 5554)
     ...
     pc-5569
       ...
       (cl:setf pc 5570)
     pc-5570
       (cl:when flag (cl:setf pc 5585) (cl:go pc-5585))
     pc-5571
       (cl:setf flag (cl:funcall (get-operation '|continuation?|) proc))
       (cl:setf pc 5572)
     pc-5572
       (cl:when flag (cl:setf pc 5578) (cl:go pc-5578))
     pc-5573
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 5574)
     pc-5574
       (cl:when flag (cl:setf pc 5583) (cl:go pc-5583))
     pc-5575
       (cl:setf continue (cl:cons '|boot-env| 5586))
       (cl:setf pc 5576)
     pc-5576
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 5577)
     ...
     pc-5592
       ...
       (cl:setf pc 5593)
     pc-5593
       (cl:when flag (cl:setf pc 5608) (cl:go pc-5608))
     pc-5594
       (cl:setf flag (cl:funcall (get-operation '|continuation?|) proc))
       (cl:setf pc 5595)
     pc-5595
       (cl:when flag (cl:setf pc 5601) (cl:go pc-5601))
     pc-5596
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 5597)
     pc-5597
       (cl:when flag (cl:setf pc 5606) (cl:go pc-5606))
     pc-5598
       (cl:setf continue (cl:cons '|boot-env| 5609))
       (cl:setf pc 5599)
     pc-5599
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 5600)
     ...
     pc-5617
       ...
       (cl:setf pc 5618)
     pc-5618
       (cl:when flag (cl:setf pc 5624) (cl:go pc-5624))
     pc-5619
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 5620)
     pc-5620
       (cl:when flag (cl:setf pc 5629) (cl:go pc-5629))
     pc-5621
       (cl:setf continue (cl:cons '|boot-env| 5632))
       (cl:setf pc 5622)
     pc-5622
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 5623)
     ...
     pc-5640
       ...
       (cl:setf pc 5641)
     pc-5641
       (cl:when flag (cl:setf pc 5647) (cl:go pc-5647))
     pc-5642
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 5643)
     pc-5643
       (cl:when flag (cl:setf pc 5652) (cl:go pc-5652))
     pc-5644
       (cl:setf continue (cl:cons '|boot-env| 5655))
       (cl:setf pc 5645)
     pc-5645
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 5646)
     ...
     pc-5661
       ...
       (cl:setf pc 5662)
     pc-5662
       (cl:when flag (cl:setf pc 5677) (cl:go pc-5677))
     pc-5663
       (cl:setf flag (cl:funcall (get-operation '|continuation?|) proc))
       (cl:setf pc 5664)
     pc-5664
       (cl:when flag (cl:setf pc 5670) (cl:go pc-5670))
     pc-5665
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 5666)
     pc-5666
       (cl:when flag (cl:setf pc 5675) (cl:go pc-5675))
     pc-5667
       (cl:setf continue (cl:cons '|boot-env| 5678))
       (cl:setf pc 5668)
     pc-5668
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 5669)
     ...
     pc-5682
       ...
       (cl:setf pc 5683)
     pc-5683
       (cl:when flag (cl:setf pc 5698) (cl:go pc-5698))
     pc-5684
       (cl:setf flag (cl:funcall (get-operation '|continuation?|) proc))
       (cl:setf pc 5685)
     pc-5685
       (cl:when flag (cl:setf pc 5691) (cl:go pc-5691))
     pc-5686
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 5687)
     pc-5687
       (cl:when flag (cl:setf pc 5696) (cl:go pc-5696))
     pc-5688
       (cl:setf continue (cl:cons '|boot-env| 5699))
       (cl:setf pc 5689)
     pc-5689
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 5690)
     ...
     pc-5705
       ...
       (cl:setf pc 5706)
     pc-5706
       (cl:when flag (cl:setf pc 5721) (cl:go pc-5721))
     pc-5707
       (cl:setf flag (cl:funcall (get-operation '|continuation?|) proc))
       (cl:setf pc 5708)
     pc-5708
       (cl:when flag (cl:setf pc 5714) (cl:go pc-5714))
     pc-5709
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 5710)
     pc-5710
       (cl:when flag (cl:setf pc 5719) (cl:go pc-5719))
     pc-5711
       (cl:setf continue (cl:cons '|boot-env| 5722))
       (cl:setf pc 5712)
     pc-5712
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 5713)
     ...
     pc-5719
       ...
       (cl:setf pc 5720)
     pc-5720
       (cl:setf pc 5722) (cl:go chunk-exit)
     pc-5721
       (cl:setf val (apply-primitive-procedure proc argl))
       (cl:setf pc 5722)
     chunk-exit)
...
(defun zone-boot-env (initial-pc initial-val initial-env initial-proc initial-argl initial-continue initial-stack)
  (cl:let ((pc initial-pc)
           ...
           (bail cl:nil))
    (cl:loop
      (cl:when (cl:or (cl:>= pc 5722) (cl:< pc 0))
