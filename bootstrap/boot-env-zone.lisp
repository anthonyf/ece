...
(defun zone-boot-env-chunk-1 (initial-pc initial-val initial-env initial-proc initial-argl initial-continue initial-stack)
  (cl:let ((pc initial-pc)
    ...
    (cl:tagbody
     ...
     pc-4149
       (cl:setf continue (cl:cons '|boot-env| 4160))
       (cl:setf pc 4150)
     pc-4150
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 4151)
     ...
     pc-4168
       ...
       (cl:setf pc 4169)
     pc-4169
       (cl:when flag (cl:setf pc 4175) (cl:go pc-4175))
     pc-4170
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 4171)
     pc-4171
     ...
     pc-4172
       (cl:setf continue (cl:cons '|boot-env| 4183))
       (cl:setf pc 4173)
     pc-4173
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 4174)
     ...
     pc-5224
       ...
       (cl:setf pc 5225)
     pc-5225
       (cl:when flag (cl:setf pc 5231) (cl:go pc-5231))
     pc-5226
       (cl:setf flag (cl:funcall (get-operation '|parameter?|) proc))
       (cl:setf pc 5227)
     pc-5227
     ...
     pc-5228
       (cl:setf continue (cl:cons '|boot-env| 5239))
       (cl:setf pc 5229)
     pc-5229
       (cl:setf val (cl:funcall (get-operation '|compiled-procedure-entry|) proc))
       (cl:setf pc 5230)
