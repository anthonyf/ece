...
The instruction executor SHALL execute a list of register machine instructions, manipulating the registers `stack`, `val`, `env`, `proc`, `argl`, and a program counter.
