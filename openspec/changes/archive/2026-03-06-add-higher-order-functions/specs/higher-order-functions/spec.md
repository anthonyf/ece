...
The evaluator SHALL provide `filter` as a built-in procedure that takes a predicate and a list, returning a new list of elements for which the predicate returns true.
