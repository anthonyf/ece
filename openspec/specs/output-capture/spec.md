...
R7RS-compatible output and input capture macros built on parameter-based current ports. Enables pure-ECE test harnesses and tools to capture program output without reaching through the CL/WASM host.
